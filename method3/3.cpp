...
// constructor
lol::lol(int i1, int i2, float f1, float f2, float f3, float f4, int i3, char* ff) {
...
int main() {
	...
	akali = new lol(5, 10, 2, 3, -5, 0.1, 10, (char*)"akali.dat");
	amumu = new lol(7, 100, -3.5, 4, 100, 10, 15, (char*)"amumu.dat");
	annie = new lol(12, 17, 0.01, 0.2, 1.5, 0.08, 20, (char*)"annie.dat");
	ashe = new lol(10, 20, 4.2, -5.3, 2.1, 0.2, 5, (char*)"ashe.dat");

	akali->WriteData(); amumu->WriteData();
	annie->WriteData(); ashe->WriteData();
	akali->~lol(); amumu->~lol();
	annie->~lol(); ashe->~lol();
